            ...
            <div className="shadow-2xl mt-6 p-3 flex items-center justify-between">
              <div className="max-w-sm">
                <div className="flex items-center gap-x-2 py-1 px-2 rounded-full text-sm font-bold bg-gray-100 w-44">
                  <img src={exclamationTriangle} alt="" className="h-5 w-5" />
                  No NFTS IN VAULT
                </div>
                <p className="text-sm mt-4">
                  Before you can publish this vault to be visible in the app, it
                  must have at least 1 NFTS minted to it.
                </p>
              </div>
              <button
          ...
          {!isPublish && isMint && (
            <div className="shadow-2xl mt-6 p-3 flex items-center justify-between">
              <div className="max-w-sm">
                ...
                <p className="text-sm mt-4">
                  This vault will not be visible in the app until it is publish.
                </p>
              </div>
              <button
                className="inline-flex items-center justify-center outline-none font-medium rounded-md
          ...
          {showDeposit && (
            <div className="shadow-2xl mt-8 p-3">
              <div className="pb-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7 sm:gap-4 gap-2 ">
                {ownerNFTs.map((item) => {
                  return (
                    <div className="group relative" key={item.number}>
                      <div
                        ...
                        onClick={() => selectNFTId(item.number)}
                      >
            ...
            <Tab.Group>
              ...
              <Tab.Panels className="mt-2">
                <Tab.Panel className="rounded-xl p-3">
                  ...
                  <div className="mt-5">
                    <h1 className="font-bold text-xl">Enable Vault Feature</h1>
                    <div className="mt-2">
                      <button
                ...
                <Tab.Panel className="rounded-xl p-3">
                  <div>
                    ...
                    <span className="text-sm">
                      Vaults can set fees that will be rewarded to vault
                      liquidity providers.
                    </span>
                  </div>
                  <div className="shadow-lg mt-6 p-3 flex items-center justify-between">
                    <div>
                      <h1 className="text-xl font-bold">Mint Fee</h1>
                      <span className="text-sm">
                        The fee token upon minting new NFTs into this vault.
                      </span>
                    </div>
                  ...
                  <div className="shadow-lg mt-6 p-3 flex items-center justify-between">
                    <div>
                      <h1 className="text-xl font-bold">Redeem Fee</h1>
                      <span className="text-sm">
                        The fee token upon redeeming a random NFT from this
                        vault.
                      </span>
                    </div>
                    <div className="flex items-center gap-x-2">
                      <input
                        ...
                        onChange={(e) => setRandomRedeemFee(e.target.value)}
                      />
                      <span className="text-lg">%</span>
                    </div>
                  </div>
                  ...
                  <div className="shadow-lg mt-6 p-3 flex items-center justify-between">
                    <div>
                      <h1 className="text-xl font-bold">Target Redeem Fee</h1>
                      <span className="text-sm">
                        The fee token upon redeeming a specific NFT from this
                        vault.
                      </span>
                    </div>
                    <div className="flex items-center gap-x-2">
                      <input
                        ...
                        onChange={(e) => setTargetRedeemFee(e.target.value)}
                      />
                      <span className="text-lg">%</span>
                    </div>
                  </div>
